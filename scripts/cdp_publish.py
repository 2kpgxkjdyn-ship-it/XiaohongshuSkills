...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Emit the final command payload as a single JSON object on stdout. "
            "Operational logs are redirected to stderr."
        ),
    )
    ...
    def emit_payload(label: str, payload: dict[str, Any]) -> None:
        if json_output:
            print(
                json.dumps({"label": label, "payload": payload}, ensure_ascii=False),
                file=json_stdout,
                flush=True,
            )
            return
    ...
    try:
        if args.command == "check-login":
            ...
            emit_payload("GET_LOGIN_QRCODE_RESULT", payload)
            ...
            emit_payload("LIST_FEEDS_RESULT", payload)
            ...
            emit_payload("SEARCH_FEEDS_RESULT", payload)
            ...
            emit_payload("GET_FEED_DETAIL_RESULT", payload)
            ...
            emit_payload("POST_COMMENT_RESULT", payload)
            ...
            emit_payload("RESPOND_COMMENT_RESULT", payload)
            ...
            emit_payload("PROFILE_SNAPSHOT_RESULT", payload)
            ...
            emit_payload("PROFILE_NOTES_RESULT", payload)
            ...
            emit_payload("NOTE_UPVOTE_RESULT", payload)
            ...
            emit_payload("NOTE_UNVOTE_RESULT", payload)
            ...
            emit_payload("NOTE_BOOKMARK_RESULT", payload)
            ...
            emit_payload("NOTE_UNBOOKMARK_RESULT", payload)
            ...
            emit_payload("GET_NOTIFICATION_MENTIONS_RESULT", payload)
            ...
            emit_payload("CONTENT_DATA_RESULT", payload)
